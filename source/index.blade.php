...
<section class="container max-w-6xl mx-auto px-6 py-10 md:py-12">
    ...
    <div class="md:flex -mx-2 -mx-4">
        ...
        <div class="mx-3 px-2 md:w-1/2">
            ...
            <p>Did you ever thought, "Wait, I'd developed this already in another project!"? I think you did. And if you would have this now as a package, available for installation, wouldn't that be incredible?</p>
        </div>
    </div>
</section>
@endsection
