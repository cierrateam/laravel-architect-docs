...
<section class="container max-w-6xl mx-auto px-6 py-10 md:py-12">
    <div class="flex flex-col-reverse mb-10 lg:flex-row lg:mb-24">
        <div class="mt-8">
            ...
            <div class="flex my-10">
                ...
                <a href="https://cierra.de" title="Cierra" class="bg-gray-400 hover:bg-gray-600 text-blue-900 font-normal hover:text-white rounded py-2 px-6">About cierra</a>
            </div>
        </div>
    ...
    <div class="md:flex -mx-2 -mx-4">
        ...
        <div class="mx-3 px-2 md:w-1/2">
            ...
            <p>Did you ever thought "Wait, I'd developed this already in annoter project!"? I think you did. And if you would have this now as a package, available for installation, wouldn't that be incrediable?</p>
        </div>
    </div>
</section>
@endsection
